...
Trailer::Trailer(   const string& regista, const string& titolo, const string& descrizione, 
                    ...
                    unsigned int nProiezioniGiornaliere, Film* film):Pubblicita(regista, titolo,descrizione, 
                    gg_mm_aaInizioRilascio,gg_mm_aaFineRilascio, visualizzaioni, durataMinuti,target,
                    nProiezioniGiornaliere),t_film(film){}
