...
inline const char *toString(Formato f)
{
    ...
    case Formato::DCP:
        return "DCP";
    case Formato::RealD_3D:
        return "RealD 3D";
    case Formato::MOV_ProRes:
        return "MOV ProRes";
    case Formato::MXF:
        return "MXF";
    case Formato::WAV_5_1:
        return "WAV 5.1";
    case Formato::WAV_7_1:
        return "WAV 7.1";
    case Formato::MOV_H264:
        return "MOV H264";
    case Formato::TIFF:
        return "TIFF";
    case Formato::IMAX_3D:
        return "IMAX 3D";
    default:
        return "Non trovato";
    }
...
inline const char *toString(FasciaOraria fo)
{
    switch (fo)
    {
    case FasciaOraria::Mattina:
        return "Mattina";
    case FasciaOraria::Pomeriggio:
        return "Pomeriggio";
...
inline const char *toString(Lingua l)
{
    switch (l)
    {
    case Lingua::Italiano:
        return "Italiano";
    case Lingua::Inglese:
        return "Inglese";
    case Lingua::Francese:
        return "Francese";
    case Lingua::Spagnolo:
        return "Spagnolo";
    case Lingua::Tedesco:
        return "Tedesco";
    case Lingua::Giapponese:
        return "Giapponese";
    case Lingua::Cinese:
        return "Cinese";
    default:
...
inline const char *toString(Classificazione c)
{
    switch (c)
    {
    case Classificazione::TUTTI:
        return "TUTTI";
    case Classificazione::SEI_PIU:
        return "6+";
    case Classificazione::QUATTORDICI_PIU:
        return "14+";
    case Classificazione::DICIOTTO_PIU:
        return "18+";
    default:
        return "Non trovato";
    }
...
inline const char *toString(Genere g)
{
    ...
    case Genere::Azione:
        return "Azione";
    case Genere::Animazione:
        return "Animazione";
    case Genere::Avventura:
        return "Avventura";
    case Genere::Commedia:
        return "Commedia";
    case Genere::Crime:
        return "Crime";
    case Genere::Drama:
    ...
    case Genere::Thriller:
        return "Thriller";
    case Genere::ScienceFiction:
        return "ScienceFiction";
    case Genere::Mistero:
        return "Mistero";
    case Genere::Western:
        return "Western";
    case Genere::Documentario:
        return "Documentario";
    case Genere::Storico:
        return "Storico";
    case Genere::Romantico:
        return "Romantico";
...
inline const char *toString(Risoluzione r)
{
    switch (r)
    {
    case Risoluzione::SD_480p:
        return "SD 480p";
    case Risoluzione::HD_720p:
        return "HD 720p";
    case Risoluzione::QHD_1440p:
        return "QHD 1440p";
    case Risoluzione::UHD_4K_2160p:
        return "UHD 4K 2160p";
    case Risoluzione::UHD_8K_4320p:
        return "UHD 8K 4320p";
    case Risoluzione::FullHD_1080p:
        return "FullHD 1080p";
    default:
        return "Non trovato";
    }
...
inline Formato toFormato(const std::string &s)
{
    if (s == "DCP")
        return Formato::DCP;
    if (s == "RealD 3D")
        return Formato::RealD_3D;
    if (s == "MOV ProRes")
        return Formato::MOV_ProRes;
    if (s == "MXF")
        return Formato::MXF;
    if (s == "WAV 5.1")
        return Formato::WAV_5_1;
    if (s == "WAV 7.1")
        return Formato::WAV_7_1;
    if (s == "MP4")
        return Formato::MP4;
    if (s == "MOV H264")
        return Formato::MOV_H264;
    if (s == "TIFF")
        return Formato::TIFF;
    if (s == "IMAX 3D")
        return Formato::IMAX_3D;
    return Formato::DCP;
}
...
inline Classificazione toClassificazione(const std::string &s)
{
    ...
    if (s == "6+")
        return Classificazione::SEI_PIU;
    if (s == "14+")
        return Classificazione::QUATTORDICI_PIU;
    if (s == "18+")
        return Classificazione::DICIOTTO_PIU;
    return Classificazione::TUTTI;
}
...
inline Genere toGenere(const std::string &s)
{
    ...
    if (s == "Animazione")
        return Genere::Animazione;
    if (s == "Avventura")
        return Genere::Avventura;
    if (s == "Commedia")
    ...
    if (s == "Thriller")
        return Genere::Thriller;
    if (s == "ScienceFiction")
        return Genere::ScienceFiction;
    if (s == "Mistero")
        return Genere::Mistero;
    if (s == "Western")
        return Genere::Western;
    if (s == "Documentario")
        return Genere::Documentario;
    if (s == "Storico")
        return Genere::Storico;
    if (s == "Romantico")
...
inline Risoluzione toRisoluzione(const std::string &s)
{
    ...
    if (s == "HD 720p")
        return Risoluzione::HD_720p;
    if (s == "FullHD 1080p")
        return Risoluzione::FullHD_1080p;
    if (s == "QHD 1440p")
        return Risoluzione::QHD_1440p;
    if (s == "UHD 4K 2160p")
        return Risoluzione::UHD_4K_2160p;
    if (s == "UHD 8K 4320p")
        return Risoluzione::UHD_8K_4320p;
    return Risoluzione::SD_480p;
}
