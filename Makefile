...
SOURCES       = main.cpp \
		...
		GUI/PathButton.cpp \
		GUI/AddMedia.cpp \
		GUI/ListPersone.cpp release/qrc_resources.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents EnumClasses.h Inserzione.h Media.h Pubblicita.h Trailer.h Film.h Podcast.h Puntata.h catch.hpp GUI/CinemaButton.h GUI/MainWindow.h GUI/CinemaSelectionPage.h GUI/SearchPanel.h GUI/PathButton.h GUI/AddMedia.h GUI/ListPersone.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp Inserzione.cpp Media.cpp Pubblicita.cpp Trailer.cpp Film.cpp Podcast.cpp Puntata.cpp test/test.cpp GUI/CinemaButton.cpp GUI/MainWindow.cpp GUI/CinemaSelectionPage.cpp GUI/SearchPanel.cpp GUI/PathButton.cpp GUI/AddMedia.cpp GUI/ListPersone.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: release/moc_CinemaButton.cpp release/moc_MainWindow.cpp release/moc_CinemaSelectionPage.cpp release/moc_SearchPanel.cpp release/moc_PathButton.cpp release/moc_AddMedia.cpp release/moc_ListPersone.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) release/moc_CinemaButton.cpp release/moc_MainWindow.cpp release/moc_CinemaSelectionPage.cpp release/moc_SearchPanel.cpp release/moc_PathButton.cpp release/moc_AddMedia.cpp release/moc_ListPersone.cpp
