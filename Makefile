...
SOURCES       = main.cpp \
		...
		GUI/PathButton.cpp \
		GUI/AddPanel.cpp release/qrc_resources.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents EnumClasses.h Inserzione.h Media.h Pubblicita.h Trailer.h Film.h Podcast.h Puntata.h catch.hpp GUI/CinemaButton.h GUI/MainWindow.h GUI/CinemaSelectionPage.h GUI/SearchPanel.h GUI/InsertCinemaPage.h GUI/PathButton.h GUI/AddPanel.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp Inserzione.cpp Media.cpp Pubblicita.cpp Trailer.cpp Film.cpp Podcast.cpp Puntata.cpp test/test.cpp GUI/CinemaButton.cpp GUI/MainWindow.cpp GUI/CinemaSelectionPage.cpp GUI/SearchPanel.cpp GUI/InsertCinemaPage.cpp GUI/PathButton.cpp GUI/AddPanel.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: release/moc_CinemaButton.cpp release/moc_MainWindow.cpp release/moc_CinemaSelectionPage.cpp release/moc_SearchPanel.cpp release/moc_PathButton.cpp release/moc_AddPanel.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) release/moc_CinemaButton.cpp release/moc_MainWindow.cpp release/moc_CinemaSelectionPage.cpp release/moc_SearchPanel.cpp release/moc_PathButton.cpp release/moc_AddPanel.cpp
...
release/InsertCinemaPage.o: GUI/InsertCinemaPage.cpp 
