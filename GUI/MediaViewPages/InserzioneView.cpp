...
void InserzioneView::updateMediaDetails()
{
    ...
    inizioP->setText(
        ...
        QString::fromStdString(dateToString(insPtr->getDataInizioRilascio())) + "</span>");

    endDateLabel->setText(
        "<span style='color: #bdced3; font-weight:bold;'>Fine proiezione: </span>"
        "<span style='color: #4e7f8b;'>" +
        QString::fromStdString(dateToString(insPtr->getDataFineRilascio())) + "</span>");

    nProiezioniGiornaliere->setText(
        "<span style='color: #bdced3; font-weight:bold;'>Numero proiezioni giornaliere: </span>"
        "<span style='color: #4e7f8b;'>" +
        QString::number(insPtr->getNProiezioniGiornaliere()) + "</span>");
