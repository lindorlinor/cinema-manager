...
void CardVisitor::visit(Film *film)
{
    if (filtro == "Film")
    {
        if (vista)
        {
            ...
            card = new HorizontalCard(*film, library);
    }
}
...
void CardVisitor::visit(Trailer *trailer)
{
    if (filtro == "Trailer")
    {
        if (vista)
        {
            ...
            card = new HorizontalCard(*trailer, library);
    }
}
...
void CardVisitor::visit(Inserzione *inserzione)
{
    if (filtro == "Inserzioni")
    {
        if (vista)
        {
            ...
            card = new HorizontalCard(*inserzione, library);
    }
}
...
void CardVisitor::visit(Podcast *podcast)
{
    if (filtro == "Podcast")
    {
        if (vista)
        {
            ...
            card = new HorizontalCard(*podcast, library);
    }
}
...
void CardVisitor::visit(Puntata *puntata)
{
    if (filtro == "Puntate")
    {
        if (vista)
        {
            ...
            card = new HorizontalCard(*puntata, library);
    }
}
